...
echo .
echo .
echo 2/7 Installing numlockx synaptic gparted gdebi cheese vlc xubuntu-restricted-extras \(non free codecs and other stuff\)...
sudo apt-get install numlockx synaptic gparted gdebi cheese vlc xubuntu-restricted-extras
...
echo .
echo .
echo 5/7 Will not set Guest autologin...
